/*
* Based on:
* URL: https://github.com/muodov/kociemba/blob/master/kociemba/ckociemba/facecube.c
* Author: Maxim Tsoy
* LICENSE: GPL-2.0
* Used by: Simon Waldhuber
* Available:https://github.com/waldhube16/Qbot_SW/blob/master/SolverBackend/AlgorithmEmbeddedC/facecube.c
*/
